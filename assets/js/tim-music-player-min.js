...
(function($) {
  $.fn.timMusicPlayer = function(playlist, userOptions) {
    var $self = this,
    ...
    playlistMgr = function() {
      ...
      markup = {
        ...
        listItem: '<li class="track">' +
          ...
          '<span class="jp-interface"></span>' +
          '<a href="#"><span class="video fa fa-video-camera"></span></a>' +
          '<a href="#" class="buy fa fa-download not-active" target="_blank"></a>' +
          '</li>'
      };

      function init(playlistOptions) {

        $myJplayer = $('.tim-music-player .jPlayer-container');
    ...
    interfaceMgr = function() {
      ...
      function buildInterface() {
        ...
        markup = '<div class="tim-music-player">' +
          ...
          '                	<span class="play jp-play"></span>' +
          '                	<span class="pause jp-pause"></span>' +
          '                </div>' +
